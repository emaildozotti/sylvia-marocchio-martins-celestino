...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'TRAVADA POR UMA MARCA ANTIGA',
  h1: 'Você não sabe mais quem é,',
  h1Em: 'nem pra onde vai, há anos.',
  subtitle: 'Reprocessamento de traumas com acolhimento cristão para mulheres travadas por marcas que terapia tradicional não acessou.',
  ctaPrimary: 'Agendar minha primeira sessão',
