...
const COPY = {
  ...
  heading: 'A marca antiga vai continuar sustentando a dor de hoje, até você acessar ela.',
  headingEm: 'A primeira sessão te mostra o que está na raiz.',
  subtitle: 'Atendimento online (principal) e presencial em Presidente Prudente, SP.',
